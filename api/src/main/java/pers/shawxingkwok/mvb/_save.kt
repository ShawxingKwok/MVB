...
// =
//     object : MVBData<LSV, T>(this, initialize){
...
//             vm.saveActions += { savedStateRegistryOwner ->
//                 val saveState = savedStateRegistryOwner.savedStateRegistry.getSavedStateProvider(key)?.saveState()
//                     ?: Bundle().also { savedStateRegistryOwner.savedStateRegistry.registerSavedStateProvider(key){ it } }
//
